...
Rectangle {
    ...
    Column {
        ...
        // CheckBox для активации всей группы
        CheckBox {
            id: groupCheckBox
            width: parent.width
            height: 20
        ...
        Column {
            width: parent.width
            height: parent.height - groupCheckBox.height - 15
            spacing: 8
    ...
    // Компоненты для полей внутри группы
    Component {
