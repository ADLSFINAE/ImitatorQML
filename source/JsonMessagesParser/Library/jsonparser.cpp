...
bool JsonParser::loadFromFile(const QString &filePath)
{
    ...
    qDebug() << "JsonParser: Successfully loaded JSON data, pages count:" << m_pagesData.size();
...
bool JsonParser::loadFromString(const QString &jsonString)
{
    ...
    qDebug() << "JsonParser: Successfully loaded JSON from string, pages count:" << m_pagesData.size();
